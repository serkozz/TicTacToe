...
namespace MyTicTacToe
{
  public class GameField
  {
    ...
    public bool DetermineWinner(char empty, char[] gameField, bool isPlayerFirstTurn, int turn, bool isPlayerVsPlayerGameMode) //Метод ввода данных и определения победителя
    {
      ...
      else if (isPlayerVsPlayerGameMode)
      {
        if (victory && turn % 2 != 0)
          Console.WriteLine("Победил игрок 1");
        else if (victory && turn % 2 == 0)
